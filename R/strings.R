...
#' @return a version of x without trailing OR leading spaces
#'
#' @examples
#' trim("foo ")
#' trim(" bar ")
...
#'
#' @param x a character vector
#' @return a version of x without trailing newline delimiters
#'
#' @examples
#' chomp("foo\n")
#' chomp("bar")
...
#'
#' @param x a character vector
#' @param n an integer of length 1.  \code{tex_wrap} will return #'
#' @return a version of x in which each element substitutes newline delimiters
#' for the immediate next space (e.g. ' ') after every nth character.
#'
#' @examples
